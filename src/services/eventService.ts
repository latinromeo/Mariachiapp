...
const initialSongs: Omit<SongDetail, 'id' | 'createdAt' | 'updatedAt'>[] = [
    ...
    { title: 'El son de la negra', artist: 'Tradicional', category: 'Corridos' },
    { title: 'La madruga', artist: 'Tradicional', category: 'Corridos' },
    { title: 'El carretero', artist: 'Tradicional', category: 'Corridos' },
    { title: 'El principio', artist: 'Varios', category: 'Corridos' },
    { title: 'El sinaloense', artist: 'Banda el Recodo', category: 'Corridos' },
    { title: 'El gusto', artist: 'Tradicional', category: 'Corridos' },
    { title: 'Jarabe tapatío', artist: 'Tradicional', category: 'Corridos' },
    { title: 'Guadalajara', artist: 'Pepe Guízar', category: 'Corridos' },
    { title: 'Jalisco', artist: 'Jorge Negrete', category: 'Corridos' },
    { title: 'Las alazanas', artist: 'Varios', category: 'Corridos' },
    { title: 'Camino de Guanajuato', artist: 'José Alfredo Jiménez', category: 'Corridos' },
    { title: 'La muerte del gallero', artist: 'Varios', category: 'Corridos' },
    { title: 'La Martina', artist: 'Antonio Aguilar', category: 'Corridos' },
    { title: 'Rosita alvirez', artist: 'Varios', category: 'Corridos' },
    { title: 'El corrido de Juan charreasqueado', artist: 'Varios', category: 'Corridos' },
    ...
    { title: 'El tenampa', artist: 'José Alfredo Jiménez', category: 'Corridos' },
    { title: 'Viva quien sabe querer', artist: 'Varios', category: 'Corridos' },
    { title: 'Triste recuerdo', artist: 'Antonio Aguilar', category: 'Corridos' },
    { title: 'Gabino barrera', artist: 'Antonio Aguilar', category: 'Corridos' },
    { title: 'Sonaron 4 balazos', artist: 'Varios', category: 'Corridos' },
    { title: 'Caballo bayo', artist: 'Antonio Aguilar', category: 'Corridos' },
    { title: 'Caballo de patas blancas', artist: 'Varios', category: 'Corridos' },
    { title: 'El prieto Satanas', artist: 'Varios', category: 'Corridos' },
    { title: 'Caballo prieto azabache', artist: 'Antonio Aguilar', category: 'Corridos' },
    { title: 'El mariachi loco', artist: 'Tradicional', category: 'Corridos' },
    { title: 'El rey', artist: 'José Alfredo Jiménez', category: 'Corridos' },
    // Serenatas
    ...
    { title: 'Mátalas', artist: 'Alejandro Fernández', category: 'Serenatas' },
    { title: 'Es la mujer', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'Mujer bonita', artist: 'Varios', category: 'Serenatas' },
    { title: 'Sublime mujer', artist: 'Varios', category: 'Serenatas' },
    { title: 'Mujeres divinas', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'Señora bonita', artist: 'Varios', category: 'Serenatas' },
    { title: 'Dentro de mi corazón', artist: 'Varios', category: 'Serenatas' },
    { title: 'Abrázame', artist: 'Alejandro Fernández', category: 'Serenatas' },
    { title: 'La mitad que me faltaba', artist: 'Alejandro Fernández', category: 'Serenatas' },
    { title: 'A pesar de todo', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'A pesar de todo', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Hermoso cariño', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'La mejor de todas', artist: 'Banda El Recodo', category: 'Serenatas' },
    { title: 'Que bonito amor', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Por amor', artist: 'José José', category: 'Serenatas' },
    { title: 'Querube', artist: 'Varios', category: 'Serenatas' },
    { title: 'Sabes una cosa', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'Por mujeres como tú', artist: 'Pepe Aguilar', category: 'Serenatas' },
    { title: 'Gata salvaje', artist: 'Varios', category: 'Serenatas' },
    { title: 'La venia bendita', artist: 'Marco Antonio Solís', category: 'Serenatas' },
    { title: 'Mi eterno amor secreto', artist: 'Marco Antonio Solís', category: 'Serenatas' },
    { title: 'A mi manera', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'O sole mio', artist: 'Luciano Pavarotti', category: 'Serenatas' },
    { title: 'Only you', artist: 'The Platters', category: 'Serenatas' },
    { title: 'Unchained melody', artist: 'The Righteous Brothers', category: 'Serenatas' },
    { title: 'New York New York', artist: 'Frank Sinatra', category: 'Serenatas' },
    { title: 'Ave María (schubert)', artist: 'Franz Schubert', category: 'Serenatas' },
    { title: 'Sin ti', artist: 'Los Panchos', category: 'Serenatas' },
    { title: 'Reloj', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'Mary es mi amor', artist: 'Leo Dan', category: 'Serenatas' },
    { title: 'Te he prometido', artist: 'Leo Dan', category: 'Serenatas' },
    { title: 'Maritza', artist: 'Varios', category: 'Serenatas' },
    { title: 'Carolina', artist: 'Varios', category: 'Serenatas' },
    { title: 'Piel de ángel', artist: 'Varios', category: 'Serenatas' },
    { title: 'Te quiero te quiero', artist: 'Nino Bravo', category: 'Serenatas' },
    { title: 'Un beso y una flor', artist: 'Nino Bravo', category: 'Serenatas' },
    { title: 'Flor pálida', artist: 'Marc Anthony', category: 'Serenatas' },
    { title: 'El loco', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Loco', artist: 'Alejandro Fernández', category: 'Serenatas' },
    { title: 'Si dios me quita la vida', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Sombras nada más', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Te amare toda la vida', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Escándalo', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'En tu pelo', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Cenizas', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Esclavo y amo', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Ojitos traidores', artist: 'Varios', category: 'Serenatas' },
    { title: 'Serrana', artist: 'Varios', category: 'Serenatas' },
    { title: 'Payaso', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'En mi viejo San Juan', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Se te olvida (La mentira)', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'La mentira (V.F)', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'Niña hechicera', artist: 'Varios', category: 'Serenatas' },
    { title: 'Para siempre', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'Estos celos', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'Que sepan todos', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'El milagro de tus ojos', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'Un millón de primaveras', artist: 'Vicente Fernández', category: 'Serenatas' },
    { title: 'El gorrión', artist: 'Varios', category: 'Serenatas' },
    { title: 'La almohada', artist: 'José José', category: 'Serenatas' },
    { title: 'Nuestro juramento', artist: 'Julio Jaramillo', category: 'Serenatas' },
    { title: 'Contigo aprendí', artist: 'Armando Manzanero', category: 'Serenatas' },
    { title: 'Somos novios', artist: 'Armando Manzanero', category: 'Serenatas' },
    { title: 'La gloria eres tú', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'La barca', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'Yo quiero ser', artist: 'Varios', category: 'Serenatas' },
    { title: 'Después del rosario', artist: 'Varios', category: 'Serenatas' },
    { title: 'Amarte a la antigua', artist: 'Pedro Fernández', category: 'Serenatas' },
    { title: 'La mochila azul', artist: 'Pedro Fernández', category: 'Serenatas' },
    { title: 'Quien', artist: 'Varios', category: 'Serenatas' },
    { title: 'Historia de un amor', artist: 'Luis Miguel', category: 'Serenatas' },
    { title: 'Madrigal', artist: 'Varios', category: 'Serenatas' },
    { title: 'Alma corazón y vida', artist: 'Varios', category: 'Serenatas' },
    { title: 'Cielito lindo', artist: 'Tradicional', category: 'Serenatas' },
    { title: 'Serenata sin luna', artist: 'Varios', category: 'Serenatas' },
    { title: 'Serenata huasteca', artist: 'José Alfredo Jiménez', category: 'Serenatas' },
    { title: 'Serenata tapatía', artist: 'Varios', category: 'Serenatas' },
    { title: 'Luz de Luna', artist: 'Javier Solís', category: 'Serenatas' },
    { title: 'Malagueña', artist: 'Tradicional', category: 'Serenatas' },
    { title: 'Cielo rojo', artist: 'Flor Silvestre', category: 'Serenatas' },
    { title: 'El pastor', artist: 'Varios', category: 'Serenatas' },
    { title: 'Te lo pido por favor', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Siempre en mi mente', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Querida', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'No me vuelvo a enamorar', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'La diferencia', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'De mi enamórate', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Te sigo amando', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'No tengo dinero', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'No vale la pena', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Hasta que te conocí', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Solo sé que fue en marzo', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Ya lo sé que tú te vas', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'El recurso', artist: 'Varios', category: 'Serenatas' },
    { title: 'Caray', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'El principio', artist: 'Varios', category: 'Serenatas' },
    { title: 'La herencia', artist: 'Varios', category: 'Serenatas' },
    { title: 'Estoy enamorado de ti', artist: 'Varios', category: 'Serenatas' },
    { title: 'Si quieres', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Me gustas mucho', artist: 'Rocío Dúrcal', category: 'Serenatas' },
    { title: 'Abrázame muy fuerte', artist: 'Juan Gabriel', category: 'Serenatas' },
    { title: 'Yo te recuerdo', artist: 'Varios', category: 'Serenatas' },
    { title: 'Por qué me haces llorar', artist: 'Juan Gabriel', category: 'Serenatas' },
];
